...
"Question " + (currentQuestion+1) + " / 100";
...
// Part 1 मध्ये questions array चालू आहे.
// खालील questions त्या array मध्ये add करायचे आहेत.
...
let attempted = selectedAnswers.filter(
...
return "Outstanding performance! You have mastered Vedic Mathematics 🎉";


else if(per>=70)

return "Great job! Keep practicing more techniques ⭐";


else if(per>=50)

return "Good effort! Practice more Sutras 📖";


else

return "Keep learning and improve your calculation skills 💪";
...
document.getElementById("reviewAttempt").innerHTML =
attempted;



document.getElementById("reviewCorrect").innerHTML =
correct;



document.getElementById("reviewWrong").innerHTML =
wrong;
