...
MySQL Server running locally (e.g. via XAMPP, WAMP, or MySQL directly) — and MySQL Workbench or phpMyAdmin to run SQL scripts
...
USE vedic_math;
Run the following table creation scripts in this order:
students table
